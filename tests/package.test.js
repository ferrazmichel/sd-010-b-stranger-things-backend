...
describe('3 - Verifica se os scripts do package.json estão corretos', () => {
  it.skip('Será validado que o comando `start` inicia o server com pm2 e se usa o ecosystem.', () => {
  ...
  it.skip('Será validado que o comando `start:dev` inicia o server com pm2, se não usa o ecosystem e abre em watchMode.', () => {
